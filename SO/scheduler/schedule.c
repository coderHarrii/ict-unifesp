 ...
 *===========================================================================*/
/* 
 * Função responsável por alterar a prioridade de processos apos uso da CPU,
 * por padrao diminui a prioridade em termos de quantum. Quanto menor o quantum 
 * restante maior a prioridade.
 */
int do_noquantum(message *m_ptr)
{
	...
	/* considerando que, no escalonamento por prioridade os processos de maior prioridade precisam 
	 * ser terminados primeiro, nos nao iremos diminuir a prioridade de um processo que sai da CPU,
	 * mas sim esperar ate que ele seja completamente terminado na sua fila de prioridade, para que dai,
	 * outros processos de menor prioridade possam ser executados
	 * 
