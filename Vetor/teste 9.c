...
int main(){
    ...
    switch(selecione){
        ...
        while(strlen(Agenda[index].contato.nome)<1||strlen(Agenda[index].contato.nome)>10){
        ...
        c_telefone=tam_telefone(telefone);

        printf("\nDigitos telefone fora do while: %d\n",c_telefone);

        while(c_telefone<10||c_telefone>11){
